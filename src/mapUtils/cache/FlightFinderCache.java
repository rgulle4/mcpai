...
public final class FlightFinderCache {
    private static FlightFinderCache instance = null;
    ...
    public static FlightFinderCache getInstance() {
        if (instance == null)
            instance = new FlightFinderCache(DB_FILE_NAME);
        return instance;
    }

    private FlightFinderCache() {
        this(DB_FILE_NAME);
    }

    private FlightFinderCache(String dbFileName) {
    ...
    public static String get(String origin, String destination) {
        String sqlSelect = (new StringBuilder("SELECT response_json "))
                .append("FROM flight_finder_cache ")
                ...
                .append(Time.valueOf(LocalTime.now()))
                .append("\';")
                .toString();
    ...
    {
        String sqlString = (new StringBuilder("INSERT INTO flight_finder_cache "))
